...
const (
	...
	PacketType_DATA_ACK  PacketType = 6
)
...
type Packet_DataAck struct {
	DataAck *DataAck `protobuf:"bytes,8,opt,name=dataAck,proto3,oneof"`
}
...
func (*DataAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_fec4258d9ecd175d, []int{7}
}
...
var fileDescriptor_fec4258d9ecd175d = []byte{
	...
	,
}
